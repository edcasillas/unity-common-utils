...
namespace CommonUtils
{
	...
	internal sealed class SimpleSceneLoader : ISceneLoaderImpl, IVerbosable {
		...
		public void LoadScene(string scenePath) => throw new NotImplementedException();
		public void LoadScene(string scenePath, Action<AsyncOperation> onReadyToActivate) => throw new NotImplementedException();
