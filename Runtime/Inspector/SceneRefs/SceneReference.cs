...
namespace CommonUtils.Inspector.SceneRefs {
    ...
    public class SceneReference : ISerializationCallbackReceiver {
        ...
        public static implicit operator string(SceneReference sceneReference) { return sceneReference.ScenePath; }
    ...
    public class SceneReferencePropertyDrawer : PropertyDrawer {
        ...
        static private class BuildUtils {
            ...
            /// </summary>
            static public void OpenBuildSettings() { EditorWindow.GetWindow(typeof(BuildPlayerWindow)); }
        }
    }
